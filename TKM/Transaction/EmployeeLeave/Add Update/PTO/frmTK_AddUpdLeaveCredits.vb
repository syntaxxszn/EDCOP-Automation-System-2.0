...
Public Class frmTK_AddUpdLeaveCredits

    Public isUpdate As Boolean = False

    Private Sub frmTK_AddEditLeaveCredits_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DropDownListLeaveType(cbLeaveType)
        SelUpd_Employee_Leave_Credits_By_ID(dgvLeaveCredits)
    End Sub
    ...
    Private Sub frmTK_AddUpdLeaveCredits_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        ClearTransactionField()
    ...
    Private Sub btnSubmitLeaveCredits_Click(sender As Object, e As EventArgs) Handles btnSubmitLeaveCredits.Click
        ProcessDataGridView_Employee_Leave_Credits(dgvLeaveCredits)
    End Sub

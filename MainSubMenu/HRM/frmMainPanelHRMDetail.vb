Public Class frmMainPanelHRMDetail
    ...
    Private Sub btnShift_Click(sender As Object, e As EventArgs) Handles btnShift.Click
        OpenChildForm_Revision(frmHR_Setup_Shift)
    End Sub

...
Public Class rpt_Administrator_PerDepartmentProjectSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_Administrator_PerDepartmentProjectSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EDCOP_Project_Monitoring_System.rpt_Administrator_PerDepartmentProjectSummary.rpt"& _ 
                ""
        End Get
        Set
            'Do nothing
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptRangeFrom() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptRangeTo() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptDeptID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_Administrator_PerDepartmentProjectSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Administrator_PerDepartmentProjectSummary = New rpt_Administrator_PerDepartmentProjectSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function

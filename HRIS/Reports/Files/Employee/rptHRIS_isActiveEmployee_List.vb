...
Public Class rptHRIS_isActiveEmployee_List
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptHRIS_isActiveEmployee_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EDCOP_Project_Monitoring_System.rptHRIS_isActiveEmployee_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_isInactive() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptHRIS_isActiveEmployee_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHRIS_isActiveEmployee_List = New rptHRIS_isActiveEmployee_List()
        rpt.Site = Me.Site
        Return rpt
    End Function

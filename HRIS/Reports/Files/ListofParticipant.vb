...
Public Class ListofParticipant
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EDCOP_Project_Monitoring_System.ListofParticipant.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TrainingRequestID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedListofParticipant
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListofParticipant = New ListofParticipant()
        rpt.Site = Me.Site
        Return rpt
    End Function

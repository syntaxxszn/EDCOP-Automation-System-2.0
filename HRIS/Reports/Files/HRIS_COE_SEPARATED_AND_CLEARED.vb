...
Public Class HRIS_COE_SEPARATED_AND_CLEARED
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "HRIS_COE_SEPARATED_AND_CLEARED.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EDCOP_Project_Monitoring_System.HRIS_COE_SEPARATED_AND_CLEARED.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHRIS_COE_SEPARATED_AND_CLEARED
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HRIS_COE_SEPARATED_AND_CLEARED = New HRIS_COE_SEPARATED_AND_CLEARED()
        rpt.Site = Me.Site
        Return rpt
    End Function

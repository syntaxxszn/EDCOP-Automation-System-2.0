...
Public Class frmHRIS_PerformanceManagement_AddUpdatePart2_FormC_Values

    Private Sub frmHRIS_PerformanceManagement_AddUpdatePart2_FormC_Values_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call SelPopulate_ActivePart1Form1CList(cbPart1, 0)
        Call SelPopulate_EmployeeName(cbReviewer)

        If isUpdate Then
            isPopulating = True
            Call SelPopulate_ActivePart1Form1CList(cbPart1, _strPerformancePart2FormCID)
            Call SelUpd_PMAS_Part2FormC_ByID()
            isPopulating = False
            Exit Sub
        End If

        _strPerformancePart2FormCID = 0 'set to ID = 0 to trigger insert in stored procedure
    End Sub
    ...
    Private Sub frmHRIS_PerformanceManagement_AddUpdatePart2_FormC_Values_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Call ClearTextBoxes(Me)
        Call ResetComboBoxes(Me)
        isUpdate = False
    ...
    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        frmHRIS_PerformanceManagement_AddUpdatePart2_FormC.ShowDialog()
    End Sub
End Class
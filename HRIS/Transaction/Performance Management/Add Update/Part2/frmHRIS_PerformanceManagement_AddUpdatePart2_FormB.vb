Public Class frmHRIS_PerformanceManagement_AddUpdatePart2_FormB

    Public B1 As New List(Of Integer)
    Public B2 As New List(Of Integer)
    Public B3 As New List(Of Integer)
    Public B4 As New List(Of Integer)
    Public B5 As New List(Of Integer)
    Public B6 As New List(Of Integer)
    Public B7 As New List(Of Integer)
    Public B8 As New List(Of Integer)

    Private Sub frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If isUpdate Then
            ...
            Call SelUpd_PMAS_Part2FormB_Value(dgv1, dgv2, dgv3, dgv4, dgv5, dgv6, dgv7, dgv8, _strPerformancePart2FormBID)
            Call UpdateTotalTFW(txtTFW1, B1, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW1)
            Call UpdateTotalTFW(txtTFW2, B2, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW2)
            Call UpdateTotalTFW(txtTFW3, B3, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW3)
            Call UpdateTotalTFW(txtTFW4, B4, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW4)
            Call UpdateTotalTFW(txtTFW5, B5, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW5)
            Call UpdateTotalTFW(txtTFW6, B6, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW6)
            Call UpdateTotalTFW(txtTFW7, B7, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW7)
            Call UpdateTotalTFW(txtTFW8, B8, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW8)
        ...
        Else
            ...
            Call Select_PMAS_Part2FormB_Value(dgv1, dgv2, dgv3, dgv4, dgv5, dgv6, dgv7, dgv8)
            Call InitializeSelectionList(dgv1.RowCount, B1)
            Call InitializeSelectionList(dgv2.RowCount, B2)
            Call InitializeSelectionList(dgv3.RowCount, B3)
            Call InitializeSelectionList(dgv4.RowCount, B4)
            Call InitializeSelectionList(dgv5.RowCount, B5)
            Call InitializeSelectionList(dgv6.RowCount, B6)
            Call InitializeSelectionList(dgv7.RowCount, B7)
            Call InitializeSelectionList(dgv8.RowCount, B8)
    ...
    'Private Sub dgvA1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv1.CellContentClick
    ...
    '            B1(e.RowIndex) = e.ColumnIndex - 1  ' This matches column 2=1, 6=5 logic (columnIndex-1)
    '        Else
    '            ' Checkbox just got unchecked
    '            B1(e.RowIndex) = 0
    '        End If

    '        UpdateTotalTFW(txtTFW1, B1, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW1)
    '    End If
    'End Sub

    'Private Sub dgvA2_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv2.CellContentClick
    '    If e.RowIndex >= 0 AndAlso e.ColumnIndex >= 2 AndAlso e.ColumnIndex <= 6 Then
    '        For col As Integer = 2 To 6
    '            If col <> e.ColumnIndex Then
    ...
    '        If Not currentValue Then
    '            B2(e.RowIndex) = e.ColumnIndex - 1
    '        Else
    '            B2(e.RowIndex) = 0
    '        End If

    '        UpdateTotalTFW(txtTFW2, B2, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW2)
    '    End If
    'End Sub
    ...
    '        If Not currentValue Then
    '            B3(e.RowIndex) = e.ColumnIndex - 1
    '        Else
    '            B3(e.RowIndex) = 0
    '        End If
    '        UpdateTotalTFW(txtTFW3, B3, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW3)
    '    End If
    'End Sub

    'Private Sub dgvA4_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv4.CellContentClick
    '    If e.RowIndex >= 0 AndAlso e.ColumnIndex >= 2 AndAlso e.ColumnIndex <= 6 Then
    '        For col As Integer = 2 To 6
    '            If col <> e.ColumnIndex Then
    ...
    '        If Not currentValue Then
    '            B4(e.RowIndex) = e.ColumnIndex - 1
    '        Else
    '            B4(e.RowIndex) = 0
    '        End If
    '        UpdateTotalTFW(txtTFW4, B4, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW4)
    '    End If
    'End Sub

    'Private Sub dgvA5_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv5.CellContentClick
    '    If e.RowIndex >= 0 AndAlso e.ColumnIndex >= 2 AndAlso e.ColumnIndex <= 6 Then
    '        For col As Integer = 2 To 6
    '            If col <> e.ColumnIndex Then
    ...
    '        If Not currentValue Then
    '            B5(e.RowIndex) = e.ColumnIndex - 1
    '        Else
    '            B5(e.RowIndex) = 0
    '        End If
    '        UpdateTotalTFW(txtTFW5, B5, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW5)
    '    End If
    'End Sub

    'Private Sub dgvA6_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv6.CellContentClick
    '    If e.RowIndex >= 0 AndAlso e.ColumnIndex >= 2 AndAlso e.ColumnIndex <= 6 Then
    '        For col As Integer = 2 To 6
    '            If col <> e.ColumnIndex Then
    ...
    '        If Not currentValue Then
    '            B6(e.RowIndex) = e.ColumnIndex - 1
    '        Else
    '            B6(e.RowIndex) = 0
    '        End If
    '        UpdateTotalTFW(txtTFW6, B6, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW6)
    '    End If
    'End Sub

    'Private Sub dgvA7_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv7.CellContentClick
    '    If e.RowIndex >= 0 AndAlso e.ColumnIndex >= 2 AndAlso e.ColumnIndex <= 6 Then
    '        For col As Integer = 2 To 6
    '            If col <> e.ColumnIndex Then
    ...
    '        If Not currentValue Then
    '            B7(e.RowIndex) = e.ColumnIndex - 1
    '        Else
    '            B7(e.RowIndex) = 0
    '        End If
    '        UpdateTotalTFW(txtTFW7, B7, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW7)
    '    End If
    'End Sub

    'Private Sub dgvA8_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv8.CellContentClick
    '    If e.RowIndex >= 0 AndAlso e.ColumnIndex >= 2 AndAlso e.ColumnIndex <= 6 Then
    '        For col As Integer = 2 To 6
    '            If col <> e.ColumnIndex Then
    ...
    '        If Not currentValue Then
    '            B8(e.RowIndex) = e.ColumnIndex - 1
    '        Else
    '            B8(e.RowIndex) = 0
    '        End If
    '        UpdateTotalTFW(txtTFW8, B8, frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_Values.txtFW8)
    '    End If
    'End Sub

    Private Sub btnNextTab1_Click(sender As Object, e As EventArgs) Handles btnNextTab1.Click
        If B1.Contains(0) Then ' only next if all rows has selected and the list does not contain id = 0
    ...
    Private Sub btnNextTab2_Click(sender As Object, e As EventArgs) Handles btnNextTab2.Click
        If B2.Contains(0) Then ' only next if all rows has selected and the list does not contain id = 0
            MessageBox.Show("You may have missed a selection. Please double-check and try again.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return
        End If
    ...
    Private Sub btnNextTab3_Click(sender As Object, e As EventArgs) Handles btnNextTab3.Click
        If B3.Contains(0) Then ' only next if all rows has selected and the list does not contain id = 0
            MessageBox.Show("You may have missed a selection. Please double-check and try again.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return
        End If
    ...
    Private Sub btnNextTab4_Click(sender As Object, e As EventArgs) Handles btnNextTab4.Click
        If B4.Contains(0) Then ' only next if all rows has selected and the list does not contain id = 0
            MessageBox.Show("You may have missed a selection. Please double-check and try again.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return
        End If
    ...
    Private Sub btnNextTab5_Click(sender As Object, e As EventArgs) Handles btnNextTab5.Click
        If B5.Contains(0) Then ' only next if all rows has selected and the list does not contain id = 0
            MessageBox.Show("You may have missed a selection. Please double-check and try again.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return
        End If
    ...
    Private Sub btnNextTab6_Click(sender As Object, e As EventArgs) Handles btnNextTab6.Click
        If B6.Contains(0) Then ' only next if all rows has selected and the list does not contain id = 0
            MessageBox.Show("You may have missed a selection. Please double-check and try again.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return
        End If
    ...
    Private Sub btnNextTab7_Click(sender As Object, e As EventArgs) Handles btnNextTab7.Click
        If B7.Contains(0) Then ' only next if all rows has selected and the list does not contain id = 0
            MessageBox.Show("You may have missed a selection. Please double-check and try again.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return
        End If
    ...
    Private Sub btnNextTab8_Click(sender As Object, e As EventArgs) Handles btnNextTab8.Click
        Dim allLists As List(Of List(Of Integer)) = New List(Of List(Of Integer)) From {B1, B2, B3, B4, B5, B6, B7, B8}
    ...
    Private Sub frmHRIS_PerformanceManagement_AddUpdatePart2_FormB_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed

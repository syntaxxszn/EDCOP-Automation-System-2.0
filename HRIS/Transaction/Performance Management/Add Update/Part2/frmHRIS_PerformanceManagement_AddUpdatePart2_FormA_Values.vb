...
Public Class frmHRIS_PerformanceManagement_AddUpdatePart2_FormA_Values
    ...
    Private Sub frmHRIS_PerformanceManagement_AddUpdatePart2_FormAValues_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call SelPopulate_ActivePart1Form1AList(cbPart1, 0)
        Call SelPopulate_EmployeeName(cbReviewer)

        If isUpdate Then
            isPopulating = True
            Call SelPopulate_ActivePart1Form1AList(cbPart1, _strPerformancePart2FormAID)
            Call SelUpd_PMAS_Part2FormA_ByID()
            isPopulating = False
            Exit Sub
        End If

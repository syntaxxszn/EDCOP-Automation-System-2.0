...
Public Class rpt_Administrator_RevFund_Summary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_Administrator_RevFund_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EDCOP_Project_Monitoring_System.rpt_Administrator_RevFund_Summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_JournalVoucherID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_Administrator_RevFund_Summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Administrator_RevFund_Summary = New rpt_Administrator_RevFund_Summary()
        rpt.Site = Me.Site
        Return rpt
    End Function
